package com.company.bill.controller;

import com.company.bill.dto.BillRequestDTO;
import com.company.bill.dto.BillResponseDTO;
import com.company.bill.service.BillService;
...
public class BillController {
    ...
    public Long createBill(@RequestBody BillRequestDTO billRequestDTO){
        return billService.createBill(billRequestDTO.getAccountId(), billRequestDTO.getAmount(), billRequestDTO.getIsDefault(),
                billRequestDTO.getCreationDate(), billRequestDTO.getOverdraftEnabled());
    }
